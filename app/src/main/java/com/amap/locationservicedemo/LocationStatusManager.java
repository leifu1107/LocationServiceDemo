...
public class LocationStatusManager {
     ...
     * @param isScreenOn 当前屏幕是否为点亮状态
     */
    public boolean isFailOnScreenOff(int errorCode, boolean isScreenOn, boolean isWifiable) {
     ...
     */
    private final String IS_LOCABLE_KEY = "is_locable_key";

    /**
     * IS_LOCABLE_KEY 的过期时间
     */
    private final String LOCALBLE_KEY_EXPIRE_TIME_KEY = "localble_key_expire_time_key";
